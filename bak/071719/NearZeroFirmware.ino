...
void Roll_vel2(){
	...
	if (sensortype2 == 0){
		...
		if (wheel2_actualvel == 0){		//Set power based on whether or not motor is moving.
			power_2 = power_2_low;		//This will be the same as power_2_high when in the "simple" fixed current mode
		}
		else {
			power_2 = power_2_high;
		}
