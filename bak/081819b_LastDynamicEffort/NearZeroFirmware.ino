...
float phase2_T_deviation_lowest;
unsigned long c2Trig1;
unsigned long c2Trig2;
unsigned long c2Trig3;
float c2TrigOffset = 0;	//Calibration value for hall/encoder. Sets offset of trigger in phase index progression (fixes there being different numbers for time delay measurements forwards and reverse.
