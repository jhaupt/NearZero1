void CheckConfig(){
	...
	if (rostopic2 == 255){
		rostopic2 = 1;		//0 = joint_commands, 1 = cmd_vel
	}
	//Read enctopic2
	iholder = EEPROM.read(addr_enctopic2);
	if (iholder == 255 || iholder == 1){enctopic2[7] = '1';}
	else if (iholder == 2){enctopic2[7] = '2';}
	else if (iholder == 3){enctopic2[7] = '3';}
	else if (iholder == 4){enctopic2[7] = '4';}
	else if (iholder == 5){enctopic2[7] = '5';}
	else if (iholder == 6){enctopic2[7] = '6';}
	else if (iholder == 7){enctopic2[7] = '7';}
	else if (iholder == 8){enctopic2[7] = '8';}
	else if (iholder == 9){enctopic2[7] = '9';}
...
void CheckMode(){
	...
	if(digitalRead(mode_ros) == LOW){     //If in USB mode, get velocity data from the ROS node.
		if (rostopic2 == 0){	//If subscribed to /joint_command...
