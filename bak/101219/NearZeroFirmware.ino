...
// address locations 40 - 69 reserved for char1 storage, locations 70 - 99 reserved for char2 storage.
...
char *rxchars_ptr = &rxchars[nchars];	//A pointer to the rosname2 memory address. This make dealing with strings much easier.
char rosname2[nchars];
int addr_rosname2;
